...
@section('content')
{!! Form::model($role, ['route' => ['Seguridad.RolesRegistrados.updateclon', $role], 'class' => 'form-horizontal', 'role' => 'form', 'method' => 'PATCH', 'id' => 'edit-role']) !!}
        ...
        <div class="card-body">
          <div class="box-body">
            ...
            <div class="callout col-sm-8 offset-sm-2" style="color: #737373;">
              ...
              <span>Los campos marcados con un asterisco (*) son obligatorios.</span><br>
              <span>Se debe cambiar el nombre del rol ya que debe ser único.</span>
            </div><br>
